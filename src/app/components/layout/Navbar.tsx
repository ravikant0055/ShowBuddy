...
const Navbar = () => {
  return (
    <div className='flex justify-between p-3 px-4 shadow '>
      ...
      <div className='flex gap-5 items-center'>
          <div className='flex items-center gap-2 bg-[#f7f7f7] rounded-xl px-3 w-[360px]'><BiSearch className='text-xl text-[#01353f]'/><input className='py-2 text-sm font-medium w-full' placeholder='Search buddy for movie, show and restaurants'/></div>

          <Link href="/" className='relative'><TbMessage className='text-2xl'/><div className='bg-[#f21111] absolute top-0 right-0 w-4 h-4 rounded-full text-white text-center text-xs flex items-center justify-center'>0</div></Link>
          <Link href="/"><VscBell className='text-xl'/></Link>
         
          <Avatar>
             <AvatarImage src="https://github.com/shadcn.pn" />
             <AvatarFallback className='bg-[#cfcfcf] p-2'><FaRegUser className='text-white text-sm'/></AvatarFallback>
          </Avatar>
      </div>
    </div>
  )
